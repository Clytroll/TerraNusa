<div class="w-64 bg-[#245B4F] min-h-screen">
    ...
    <nav class="mt-6">
        <a href="../" class="flex items-center px-6 py-3 text-white/90 hover:bg-white/10">
        ...
        <a href="../logout.php" class="flex items-center px-6 py-3 text-white/90 hover:bg-red-600">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
