<?php
$pageTitle = "Nature Escape";

require_once 'includes/header.php';
require_once 'includes/navbar.php';
$basePrice = 850000; // Harga dasar per orang
?>
        ...
        <div class="container-custom">
            ...
            <div class="mb-6">
                <div class="flex items-center space-x-2 text-sm text-gray-600">
                    ...
                    <span>/</span>
                    <span class="text-primary">Nature Escape (2D1N)</span>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <div class="bg-white rounded-lg p-6 shadow-lg">
                    ...
                    <form id="bookingForm" action="process_order.php" method="POST">
                        <input type="hidden" name="package_id" value="4"> <!-- ID untuk Nature Escape -->
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-tertiary/20 p-4 rounded-lg">
                                <div class="flex justify-between items-center text-lg font-semibold">
                                    ...
                                    <input type="hidden" name="totalAmount" id="totalAmountInput" value="850000">
                                </div>
                            </div>
